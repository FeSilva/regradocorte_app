...
class RegisterBarberPage extends StatefulWidget {
  @override
  _RegisterBarberPageState createState() => _RegisterBarberPageState();
}

class _RegisterBarberPageState extends State<RegisterBarberPage> {
  TextEditingController nameController = TextEditingController();
  TextEditingController emailController = TextEditingController();
  TextEditingController passwordController = TextEditingController();
  TextEditingController confirmPasswordController = TextEditingController();
  TextEditingController shalonController = TextEditingController();
      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            ...
            TextFormField(
              controller: shalonController,
              keyboardType: TextInputType.emailAddress,
              decoration: InputDecoration(
                labelText: 'Qual o nome da sua Barbearia ?',
                filled: true,
  ...
  void _registerUser() async {
    if (passwordController.text == confirmPasswordController.text) {
      ...
      try {
        SignUpService()
          .signUpShalon(emailController.text, passwordController.text, nameController.text, shalonController.text);
          Navigator.push(
            context,
            MaterialPageRoute(
